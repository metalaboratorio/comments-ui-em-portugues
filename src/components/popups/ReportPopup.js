...
const ReportPopup = (props) => {
    ...
    return (
        <div className="rounded-none relative h-screen w-screen bg-white p-[28px] text-center shadow-modal sm:h-auto sm:w-[500px] sm:rounded-xl sm:p-8 sm:text-left" onMouseDown={stopPropagation}>
            <h1 className="mb-1 font-sans text-[24px] font-bold tracking-tight text-black">Você quer denunciar<span className="hidden sm:inline"> esse comentário</span>?</h1>
            <p className="text-base px-4 font-sans leading-9 text-neutral-500 sm:pl-0 sm:pr-4">O seu pedido será enviado para o responsável dessa plataforma.</p>
